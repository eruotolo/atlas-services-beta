...
|---|---|---|---|
| Q1 | ¿Razón social, país de constitución, domicilio y representante legal del operador de Hireeo? | Sin esto no se puede redactar Términos ni Política de Privacidad, ni identificar al responsable/controlador. Bloquea Fase 1 (textos de consentimiento finales) y Fase 7 (retirar borrador). | |
| Q2 | Cuando pagos salga de *stub*: ¿quién es merchant of record, quién liquida al prestador, quién retiene la comisión del 15%? | Determina licencias de dinero, PCI, DAC7/IVA y responsabilidad de consumo. Bloquea Fase 6 completa. | |
