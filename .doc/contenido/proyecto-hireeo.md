...
| Fase 4 — Escrow | 🔴 Pendiente | Split Payments, Escrow, comisión 15%, retargeting email (Brevo CronJobs) — ver DT-01/DT-09 |

> El módulo **Sponsors** (mencionado en versiones anteriores de este doc y en el DevLog de abajo) fue **eliminado por completo** del código (migración `remove_sponsors`, 2026-08). Fue una decisión de producto, no deuda pendiente.
