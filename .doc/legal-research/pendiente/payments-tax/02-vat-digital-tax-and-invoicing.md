...
**Fuente base:** investigación de fuentes primarias por agente Haiku 4.5 (`payments-tax/research-raw/haiku-research-fase8-raw.md`), con corrección crítica verificada por Sonnet 5 en §2.
