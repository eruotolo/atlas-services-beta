...
| OBL-06 (canal de derechos) | `EV-02` (patrón de stub similar), `RIGHTS-Q1/Q2` | Product / Engineering / Legal | BLOCKING | 15-45 días | FRONTEND IMPLEMENTADO 2026-08-27 (Centro de privacidad en `features/users/components/privacy/PrivacyCenter`, envía por email vía `enviarSolicitudSoporte`, sin persistencia/id/estado) — falta backend real con contrato de Fase 0 |
...
| OBL-22 (recolección de datos fiscales DAC7) | `payments-tax/02` §2 | Finance / Engineering | HIGH | Pre-lanzamiento en UE con pagos reales | FRONTEND PARCIAL 2026-08-27 (`FiscalDataForm` en profile/settings, solo country=es, captura por email vía `enviarSolicitudSoporte`, no persiste en el modelo de usuario) — falta backend + modelo de pagos (Q2) |
| OBL-24 (notice-and-action) | `marketplace/01` §5 (brecha) | Trust & Safety / Product | HIGH (UE), RECOMMENDED (resto) | 46-90 días | FRONTEND PARCIAL 2026-08-27 (entradas contextuales de "Reportar" desde servicio/reseña/perfil/chat vía `ReportButton`, reusan el email de `/contact`) — falta backend de casos con decisión motivada y apelación |
| OBL-26 (verificación de licencias en oficios regulados) | `marketplace/01` §4 | Trust & Safety / Engineering | HIGH | 46-90 días | FRONTEND PARCIAL 2026-08-27 (`LicenseCredentialsForm` en profile/settings, captura por email, sin verificación) — falta matriz de categorías reguladas y backend |
