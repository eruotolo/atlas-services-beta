...
**Fuente base:** investigación de fuentes primarias por agente Haiku 4.5 (`consumer-and-commercial/research-raw/haiku-research-fase7-raw.md`), con verificación selectiva de los hallazgos más relevantes por Sonnet 5 (ver §3).
