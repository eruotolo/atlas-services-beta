    ...
    return (
        <span
            className={`inline-flex items-center gap-1 rounded-full font-bold tracking-wider uppercase ${
                isSmall
                    ? 'bg-gradient-to-r from-amber-50 to-yellow-50 px-2 py-0.5 text-[8px] text-amber-700'
                    : 'bg-gradient-to-r from-amber-50 to-yellow-50 px-2.5 py-1 text-[9px] text-amber-700 shadow-sm shadow-amber-100 md:text-[10px]'
            }`}
