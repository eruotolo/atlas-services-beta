...
export function PaymentBrickStripe({
    ...
    return (
        <div className="rounded-[2rem] border border-line bg-bg p-6 shadow-sm">
            ...
            <p className="mb-5 text-center text-3xl font-black text-brand">
                {formattedAmount}
            </p>
            ...
            <button
                ...
                disabled={loading}
                className="flex w-full cursor-pointer items-center justify-center gap-2 rounded-2xl bg-violet-600 py-3.5 text-sm font-bold text-white shadow-lg shadow-violet-900/10 transition-all hover:bg-violet-700 disabled:cursor-not-allowed disabled:opacity-50"
            >
                {loading ? (
                    <>
