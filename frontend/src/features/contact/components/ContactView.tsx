    ...
    const inner = (
        <>
            ...
            <div className="min-w-0 flex-1">
                ...
                <div
                    className="mt-0.5 text-[15.5px] font-semibold"
                    style={{ color: 'var(--ink)' }}
                >
                    {value}
                </div>
                <div className="mt-1 text-[12.5px]" style={{ color: 'var(--sub)' }}>
                    {sub}
                </div>
            </div>
        </>
    ...
    return (
        <section style={{ background: 'var(--bg)', color: 'var(--ink)' }}>
            <div className="mx-auto grid max-w-[1100px] grid-cols-1 gap-12 px-6 py-16 sm:px-10 lg:grid-cols-[1fr_1.1fr] lg:gap-20 lg:px-14 lg:py-24">
                ...
                <div
                    className="rounded-[14px] border bg-bg p-8"
