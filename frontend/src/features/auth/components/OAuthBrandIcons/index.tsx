...
// Icons sourced from Material Design Icons (Apache 2.0) via icons0 MCP
// mdi:google | mdi:apple | mdi:microsoft

type IconProps = SVGProps<SVGSVGElement> & { size?: number };

export function GoogleIcon({ size = 18, ...props }: IconProps): ReactElement {
    return (
...
export function AppleIcon({ size = 18, ...props }: IconProps): ReactElement {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" aria-hidden="true" {...props}>
...
export function MicrosoftIcon({ size = 18, ...props }: IconProps): ReactElement {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" aria-hidden="true" {...props}>
