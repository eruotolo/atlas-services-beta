...
export function AuthShell({
    ...
    return (
        <div
            className="grid min-h-screen w-full grid-cols-1 lg:grid-cols-2 bg-bg text-ink"
        >
            <div className={`flex flex-col px-8 py-10 sm:px-12 lg:px-16 ${formOrder}`}>
                <div className="mb-12 flex items-center justify-between">
                    ...
                    <Mono
                        className="text-[11px] tracking-[0.08em] text-sub"
                    >
                        HIREEO 2.0 · BETA
                    </Mono>
                </div>
                ...
                <div
                    className="mt-8 flex items-center justify-between pt-8 text-[11.5px] text-muted"
                >
            ...
            <div
                className={`relative hidden flex-col justify-between overflow-hidden p-14 lg:flex ${visualOrder} bg-[#0A0A0A] text-[#FAFAFA]`}
            >
                <div
                    aria-hidden
                ...
                <div className="relative z-[1]">
                    <Mono
                        className="text-[11px] font-semibold tracking-widest text-accent-bright"
                    >
                        — TESTIMONIO
                    </Mono>
                    <p
                        className="m-0 mt-5 max-w-[480px] font-medium leading-tight tracking-[-0.02em]"
                        style={{
                            fontSize: 28}} 
                    >
                ...
                >
                    ...
                    <div className="mt-3 flex items-baseline justify-between">
                        <div
                            style={{
                                fontSize: 28}} className="font-medium tracking-[-0.02em]"
                        >
                            4.281
                        </div>
                        <span className="text-[11px] text-[#7FE5A7]">
                            ↑ +12%
                        </span>
                    </div>
