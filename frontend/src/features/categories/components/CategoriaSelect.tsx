                    ...
                    <div className="border-b border-line p-3">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full rounded-xl border border-line bg-bg py-2 pr-3 pl-10 text-sm text-ink focus:border-brand focus:ring-2 focus:ring-brand/20 focus:outline-none"
                            />
                        </div>
                    </div>
