...
export default async function HomePage() {
    // Obtener las 4 categorías principales (con más servicios premium o aleatorias)
    ...
    // Obtener servicios destacados de la BD
    const realFeaturedServices = await getPublicFeaturedServices();

    // Si no hay servicios en la BD, usar los de prueba (mock)
    // Se duplican para mostrar 8 items como placeholder
    ...
    // Obtener sponsors
    const sponsorsSenior = await getSponsorsSenior();
    const sponsorsPremium = await getSponsorsPremium();
    ...
    return (
        <>
            ...
            {/* Categorías rápidas: 4 categorías con más servicios premium o aleatorias */}
            <HeroCategories categories={heroCategories} />

            {/* SPONSOR SENIOR - Slider máximo 3 items o Espacio Publicitario */}
            ...
            {/* SECCIÓN AUTO-PUBLICIDAD "HAZTE PREMIUM" */}
                        ...
                        <div className="relative z-10 flex flex-col items-center justify-between gap-8 md:flex-row">
                            <div className="max-w-xl text-center md:text-left">
                                ...
                                <p className="text-base leading-relaxed font-medium text-blue-100 opacity-90 md:text-lg">
                                    Únete a Chiloé Pro y destaca sobre la competencia. Atrae hasta
                                    5x más clientes.
                                </p>
                            </div>
            ...
            {/* SPONSOR PREMIUM - Avisos de la Comunidad / Publicidad */}
