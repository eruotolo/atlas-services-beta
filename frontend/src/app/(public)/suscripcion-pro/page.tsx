...
export const metadata: Metadata = {
    ...
    description:
        'Destaca tu servicio en Chiloé con nuestros planes Premium. Aparece primero en búsquedas, obtén el sello Pro y atrae hasta 5x más clientes. Planes desde 1 mes con descuentos por volumen.',
    keywords: [
        'suscripción premium Chiloé',
        'planes destacados',
        'servicio premium',
    ...
    openGraph: {
        title: 'Planes Premium - Destaca tu Servicio en Chiloé',
        description:
            'Aparece primero en las búsquedas y atrae hasta 5 veces más clientes con planes premium.',
        type: 'website',
    },
    alternates: {
        canonical: '/suscripcion-pro',
    },
};

export default async function SuscripcionProPage() {
    const precios = await obtenerPreciosPremiumActivos();
            ...
            <div className="container mx-auto max-w-7xl px-4">
                <div className="mb-12 text-center md:mb-16">
                    ...
                    <p className="mx-auto max-w-2xl px-2 text-base text-gray-600 md:text-lg dark:text-gray-400">
                        ...
                        nuestros planes premium diseñados para la isla.
                    </p>
                </div>

                <div className="grid grid-cols-1 gap-6 md:grid-cols-4 md:gap-6">
                    {precios.length > 0 ? (
                        precios.map((plan, _idx) => {
                                    ...
                                    <div className="mb-6">
                                        ...
                                        {plan.duracionMeses > 1 && (
                                            <p className="mt-1 text-xs font-medium tracking-tight text-blue-400 uppercase dark:text-blue-500">
                                                Solo ${precioMensual.toLocaleString('es-CL')} al mes
                                            </p>
                                        )}
                                    </div>
