...
export async function generateMetadata({
    ...
    const dict = getPageDictionary<QuienesDict>('quienes-somos', country);
    return {
        title: dict.meta.title,
        description: dict.meta.description,
        alternates: { canonical: `/${country}/quienes-somos` },
    };
}
...
export default async function QuienesSomosPage({
    ...
    return (
        <div style={{ background: 'var(--bg)', color: 'var(--ink)' }}>
            ...
            <section className="mx-auto max-w-[1100px] px-6 pb-12 sm:px-10 lg:px-14">
                <div
            ...
            <section className="mx-auto max-w-[1100px] px-6 py-12 sm:px-10 lg:px-14">
            ...
            <section className="mx-auto max-w-[1100px] px-6 py-12 pb-20 sm:px-10 lg:px-14">
