...
function buildPlanViewModel(plan: BackendPrecio, country: string): PlanViewModel {
    ...
    return {
        ...
        ctaHref: `/${country}/publish?plan=${plan.id}`,
    };
}
...
export default async function SuscripcionProCountryPage({ params }: Props): Promise<ReactElement> {
    ...
    return (
        <div style={{ background: 'var(--bg)', color: 'var(--ink)' }}>
            <section className="mx-auto w-full max-w-site px-6 pt-20 pb-12 text-center sm:px-10 lg:px-14">
                ...
                >
                    <AnimatedRotatingText
                        delay={300}
                        speed={40}
                        segments={[{ text: 'Para los que viven\ndel oficio.' }]}
                    />
                </h1>
                <p
            ...
            <section className="mx-auto w-full max-w-site px-6 pb-20 sm:px-10 lg:px-14">
                ...
                >
                    <AnimatedRotatingText
                        delay={200}
                        speed={40}
                        segments={[{ text: 'Free vs Pro, en detalle.' }]}
                    />
                </h2>
                <div
